...
#define NUMBER_OF_BASE_FUNCTIONS 4
#define DEGREE 3
...
double b_0(double u) {
    return ((double)1)/6 * pow(u, 3);
}

double b_1(double u) {
    return ((double)1) / 6 * (1 + 3 * u + 3 * pow(u, 2) - 3 * pow(u, 3));
}

double b_2(double u) {
    return ((double)1) / 6 * (4 - 6 * pow(u, 2) + 3 * pow(u, 3));
}

double b_3(double u) {
    return ((double)1) / 6 * (1 - 3 * u + 3 * pow(u, 2) - pow(u, 3));
}
...
void spline_approximation(double (*f)(double))
{
    ...
    for (int i = 0; i < NUMBER_OF_NODES; i++)
    {
        a[i * NUMBER_OF_BASE_FUNCTIONS + 0] = b_0(approx_nodes_x[i]);
        printf("%f ", a[i * NUMBER_OF_BASE_FUNCTIONS + 0]);
        a[i * NUMBER_OF_BASE_FUNCTIONS + 1] = b_1(approx_nodes_x[i]);
        printf("%f ", a[i * NUMBER_OF_BASE_FUNCTIONS + 1]);
        a[i * NUMBER_OF_BASE_FUNCTIONS + 2] = b_2(approx_nodes_x[i]);
        printf("%f ", a[i * NUMBER_OF_BASE_FUNCTIONS + 2]);
        a[i * NUMBER_OF_BASE_FUNCTIONS + 3] = b_3(approx_nodes_x[i]);
        printf("%f ", a[i * NUMBER_OF_BASE_FUNCTIONS + 3]);
        printf("\n");
    }
    // A transposed
